...
namespace SpediaLibrary.Business
{
    ...
    public static class GerenciamentoUsuario
    {
        ...
        /// <summary>
        /// Obtém a lista de valores dos atributos adicionais vinculados ao usuário
        /// </summary>
        /// <param name="idUsuario">Identificador do usuário</param>
        /// <returns>Lista de valores de atributos adicionais</returns>
        public static IList<AtributoAdicional> ObtemAtributosAdicionais(int idUsuario)
        {
            try
            {
                string json = AuxiliarJson.Obtem(EnderecosApi.Usuario + "/" + idUsuario + "/" + EnderecosApi.Atributos);
        ...
        /// <summary>
        /// Atribui ao usuário os valores de atributo adicional
        /// </summary>
        /// <param name="idUsuario">Identificador do usuário</param>
        ...
        public static bool AtribuiValorAtributoAdicional(int idUsuario, List<int> valoresAtributoAdicional)
        {
            try
            {
                foreach (int valor in valoresAtributoAdicional)
                {
                    AuxiliarJson.Coloca(null, EnderecosApi.Usuario + "/" + idUsuario + "/" + EnderecosApi.Atributo + "/" + valor, true);
                }
        ...
        /// <summary>
        /// Remove do usuário os valores de atributo adicional
        /// </summary>
        /// <param name="idUsuario">Identificador do usuário</param>
        /// <param name="valoresAtributoAdicional">Lista de identificadores dos valores do atributo adicional</param>
        /// <returns>Indica se a remoção foi bem sucedida</returns>
        public static bool RemoveValorAtributoAdicional(int idUsuario, List<int> valoresAtributoAdicional)
        {
            try
            {
                foreach (int valor in valoresAtributoAdicional)
                {
                    AuxiliarJson.Exclui(EnderecosApi.Usuario + "/" + idUsuario + "/" + EnderecosApi.Atributo + "/" + valor);
                }
