////-----------------------------------------------------------------------
//// <copyright file="ItemNotificacao.cs" company="SpediA">
...
namespace SpediaLibrary.Transfer
{
    ...
    /// <summary>
    /// Classe modelo de item de notificação
    /// </summary>
    public class ItemNotificacao
    {
        ...
        /// <summary>
        /// Obtém ou define o tipo da notificação
        /// </summary>
        ...
        /// <summary>
        /// Obtém ou define o identificador do arquivo associado a notificação
        /// </summary>
        public virtual int IdArquivo { get; set; }

        /// <summary>
        /// Obtém ou define a data em que ocorreu a notificação
        /// </summary>
